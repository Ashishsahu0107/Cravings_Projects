  ...
  return (
    <main className="flex h-[90vh] items-center justify-end bg-[url('/FeedbackPage.jpeg')] bg-cover bg-center p-6 md:p-10 md:pe-30">
      <div className="max-h-[85vh] w-full max-w-md overflow-y-auto rounded-lg bg-white px-8 py-6 shadow-md md:px-10">
        <h1 className="mb-2 text-center text-3xl font-bold text-(--color-primary)">Share Feedback</h1>
        <p className="mb-5 text-center text-(--color-secondary)">Help us improve your Cravings experience.</p>
        {submitted && (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input className="mb-4 w-full rounded-md border border-(--color-base-300) px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-(--color-primary)" placeholder="Enter your full name" required />

          <label className="mb-2 block font-semibold text-(--color-neutral)">Email</label>
          <input type="email" className="mb-4 w-full rounded-md border border-(--color-base-300) px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-(--color-primary)" placeholder="Enter your email" required />

          <label className="mb-2 block font-semibold text-(--color-neutral)">Feedback Category</label>
          <select className="mb-4 w-full rounded-md border border-(--color-base-300) px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-(--color-primary)" required>
          ...
          <textarea className="mb-6 w-full resize-none rounded-md border border-(--color-base-300) px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-(--color-primary)" rows={3} placeholder="Tell us about your experience..." required />
