            ...
            <div className='h-[90vh] bg-[url("/foodTable.webp")] bg-yellow-400 grid items-center justify-start bg-cover bg-center md:ps-30 '>
                <div className='bg-white p-10 grid gap-8 rounded-md w-100'>
                    <div className='grid gap-3'>
                        <h1 className='text-4xl text-center font-semibold text-(--color-primary) '>Welcome Back</h1>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type='submit' className='w-full py-2 mb-4 rounded-md bg-(--color-primary) text-white text-lg'>Login</button>
                        <div className='flex items-center justify-center gap-2 mb-2'>
                            <div className='w-17 border' />
                            <p className=''>Don't have an account?</p>
                            <div className='w-17 border' />
                        </div>
                        <p className='text-center '><span onClick={() => navigate("/register")} className='text-(--color-primary) cursor-pointer '>Create an account</span></p>
                    </form>
                </div>
            </div>
        </>
